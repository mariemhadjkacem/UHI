...
have many subdivisions with numbers. Normally the subdivision name is the same as the road name, but with a number to identify it. Eg. SOI SUKUMVIT 3, SUKUMVIT RD, BANGKOK</xs:documentation>
		</xs:annotation>
		<xs:complexType>
			<xs:sequence>
				<xs:element ref="AddressLine" minOccurs="0" maxOccurs="unbounded"/>
...
one premise in a street referenced in an address. For example a building address near a major shopping centre or raiwlay station</xs:documentation>
		...
		<xs:complexType>
			<xs:sequence>
				...
				<xs:element name="PremiseName" minOccurs="0" maxOccurs="unbounded">
					...
					<xs:complexType mixed="true">
						...
						<xs:attribute name="TypeOccurrence">
							<xs:annotation>
								<xs:documentation>EGIS Building where EGIS occurs before Building, DES JARDINS occurs after COMPLEX DES JARDINS</xs:documentation>
							</xs:annotation>
							<xs:simpleType>
								<xs:restriction base="xs:NMTOKEN">
									<xs:enumeration value="Before"/>
			...
			<xs:attribute name="Type">
				<xs:annotation>
					<xs:documentation>COMPLEX in COMPLEX DES JARDINS, A building, station, etc</xs:documentation>
				</xs:annotation>
			</xs:attribute>
