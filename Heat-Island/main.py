...
# =======================================================
# Ajout des colonnes LST et NDVI
feature_cols = [
    ...
    'distance_to_water', 'LST', 'NDVI'  # LST et NDVI ajoutés comme caractéristiques supplémentaires
]

# Assurez-vous que seules les colonnes existantes sont sélectionnées
...
print("Features utilisées pour l'entraînement : ", X.columns)
